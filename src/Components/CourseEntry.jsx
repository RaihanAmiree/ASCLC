...
>
  {/* Icon/Visual Element */}
  <svg className="w-16 h-16 sm:w-20 sm:h-20 text-[#241571] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <p className="text-base sm:text-lg text-gray-600 mb-6 max-w-xs">
    This segment offers some popular free video courses on career building guidelines
  </p>
